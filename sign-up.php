...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $checkUsernameSQL = "SELECT id FROM users WHERE email = ?";
  if ($stmt = $mysqli->prepare($checkUsernameSQL)) {
    ...
    if ($stmt->num_rows > 0) {
      ...
      $insertSQL = "INSERT INTO users (name, email, password, phone) VALUES (?, ?, ?, ?)";
...
<body>
  ...
  <div class="container">
    <div class="navbar-top">
      ...
      <div class="logo">
        <h3><a href="/index.php" style="color: black;">FURNITURE</a></h3>
      </div>
      <div class="icons">
    ...
    <div class="d-flex-center">
      <div class="form-div">
        <form method="POST" id="login-form">
          ...
          <button type="submit" style="margin-bottom: 0;">Sign Up</button>
          <p style="margin-top: 10px; margin-bottom: 10px; font-weight: bold; font-size: 30px;">OR</p>
          <button type="menu" style="margin-bottom: 0;"><a href="/login.php" style="color: black;">Log In</a></button>
        </form>
      </div>
